...
export const metadata: Metadata = {
  ...
  description:
    'Bộ 36 câu hỏi kinh điển từ nghiên cứu tâm lý học 1997 giúp cặp đôi hiểu nhau sâu hơn: bản Việt hóa đầy đủ 3 phần, cách dùng đúng và cách biến thành nghi thức hằng tuần.',
};
...
export default function Page() {
  ...
  return (
    <BlogArticle
      post={post}
      title="36 câu hỏi để hiểu nhau sâu hơn — và cách dùng chúng cho đúng"
