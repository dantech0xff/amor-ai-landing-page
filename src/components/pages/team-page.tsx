      ...
      >
        ...
        >
          ...
          >
            {vi ? (
              <>
                Nhiều câu trả lời đã có sẵn trong <Link href={localePath('/faq', lang)}>FAQ</Link>. Về
                pháp lý, xem <Link href={localePath('/terms', lang)}>Điều khoản</Link> và{' '}
                <Link href={localePath('/privacy', lang)}>Quyền riêng tư</Link>.
              </>
            ) : (
              <>
                Many answers already live in the <Link href={localePath('/faq', lang)}>FAQ</Link>. For
                legal matters, see the <Link href={localePath('/terms', lang)}>Terms</Link> and{' '}
                <Link href={localePath('/privacy', lang)}>Privacy Policy</Link>.
              </>
            )}
          </p>
        </div>
